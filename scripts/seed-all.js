const { PrismaClient } = require('../lib/client');
...
const boardMembers = [
    { name: "Prof. Dr. Ir. Zainal A. Hasibuan, MLS., Ph.D.", position: "Ketua Umum", department: "Executive Board", image: "https://randomuser.me/api/portraits/men/1.jpg", period: "2022-2026" },
    { name: "Prof. Dr. Achmad Benny Mutiara, S.Si., S.Kom.", position: "Sekretaris Jenderal", department: "Executive Board", image: "https://randomuser.me/api/portraits/men/2.jpg", period: "2022-2026" },
    { name: "Dr. Dwiza Riana, S.Si., M.M., M.Kom.", position: "Bendahara Umum", department: "Executive Board", image: "https://randomuser.me/api/portraits/women/3.jpg", period: "2022-2026" },
    { name: "Prof. Dr. Ema Utami, S.Si., M.Kom.", position: "Wakil Ketua I (Bidang Akademik)", department: "Vice Chairmen", image: "https://randomuser.me/api/portraits/women/4.jpg", period: "2022-2026" },
    { name: "Solikin, S.Si., M.T.", position: "Wakil Ketua II (Bidang SDM)", department: "Vice Chairmen", image: "https://randomuser.me/api/portraits/men/5.jpg", period: "2022-2026" },
];
...
async function main() {
    ...
    // Note: Only do this for these types of tables, keep profile if you want
    ...
    await prisma.individualMember.deleteMany();
    ...
    await prisma.memberInstitution.createMany({ data: institutions });
    ...
    await prisma.individualMember.createMany({ data: individualMembers });
